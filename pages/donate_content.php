<div class="wrapper">
    ...
    <article>
        ...
        <div class="donationBonuses">
            ...
            <div class="donationBonusCard">
                <div class="donationBonusTitle">от 2048 руб.</div>
                <div>
                    Код-ревью для ваших решений.<br>
                    Добавление в отдельный класс на Stepik, где я могу отслеживать ваш прогресс по курсу и делать код-ревью для ваших решений (по запросу).<br>
                    Количество учеников в подобном классе пока ограничиваю десятью. Это нужно, чтобы не переживать о двух вещах: 
