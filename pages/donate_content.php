<div class="wrapper">
    ...
    <article>
        ...
        <p>Все материалы курса <strong>принципиально</strong> останутся бесплатными для всех желающих.</p>

        <p>Но создание и поддержка курса — это сотни часов работы крошечной команды энтузиастов.</p>
        ...
        <p>Перевод через системы Yoomoney и WebMoney:
